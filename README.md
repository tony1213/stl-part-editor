...
<td align="center"><img src="screenshots/isolate.png" width="480"/><br><b>只看选中</b>（单独拎出一个零件确认是不是电机）</td>
</tr>
<tr>
<td align="center" colspan="2"><img src="screenshots/result.png" width="480"/><br><b>剔除后</b>（10.7 万面 → 4.2 万面，外形一模一样）</td>
</tr>
</table>
...
- `只看选中`（快捷键 <kbd>I</kbd>）单独看一个零件，确认它到底是什么
- `显示被删零件`（快捷键 <kbd>H</kbd>）切换红色件的显示
- `全保留` / `全删除` / `按阈值重算`
- <kbd>Delete</kbd> 删除当前选中零件

### 视图
- 左键拖动旋转，滚轮缩放，右键拖动平移
- 灰色 = 保留，红色 = 待删，青色 = hover / 选中
- 跟随系统亮色/暗色主题
